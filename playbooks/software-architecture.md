...
- **Kepatuhan Asumsi Nihil**: Seluruh keputusan arsitektur (ADR) dan dokumen arsitektur (SAD) tidak memuat batasan teknis atau infrastruktur di luar apa yang didefinisikan dalam `project-knowledge.md` (Sesuai `[RULE-HITL-001]`).
...
| 1.2 | Standardisasi aturan Kepatuhan Asumsi Nihil (RULE-HITL-001) pada checklist arsitektur |